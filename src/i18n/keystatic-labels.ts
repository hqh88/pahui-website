...
const labels = {
  ...
  catSofas: { en: 'Sofas', zh: 'Sofas' },
  catArmChairs: { en: 'Arm Chairs', zh: 'Arm Chairs' },
  catCoffeeTables: { en: 'Coffee Tables', zh: 'Coffee Tables' },
  catDiningTables: { en: 'Dining Tables', zh: 'Dining Tables' },
  catDiningChairs: { en: 'Dining Chairs', zh: 'Dining Chairs' },
  catBeds: { en: 'Beds', zh: 'Beds' },
  catBedsideTables: { en: 'Bedside Tables', zh: 'Bedside Tables' },
  catOthers: { en: 'Others', zh: 'Others' },
